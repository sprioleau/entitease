...
export const entitiesList: EntitityCategory[] = [
	{
	...
	{
		categoryLabel: "Miscellaneous Symbols",
		entities: [
			{
				symbol: "©",
				entity: "&copy;",
	...
	{
		categoryLabel: "Punctuation Symbols",
		entities: [
			{
				symbol: "!",
				entity: "&excl;",
